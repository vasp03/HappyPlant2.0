...
import com.server.model.ErrorResponse;
...
public class APIRunner {
    ...
    public APIRunner(Controller controller) {
    ...
    public void registerEndpoints(
            ArrayList<APIEndpoint> getEndpoints,
            ArrayList<APIEndpoint> postEndpoints,
    ...
    public APIRunner start() {
        ...
        app.start(controller.getServerInstance().getHOST(), controller.getServerInstance().getPORT());
        return this;
    }
